...
const routes: Routes = [
  ...
  {path: 'productlist', component: ProductlistComponent, data: {title: 'Products'}, canActivate: [AuthGuard]},

  {path: 'services', component: ServicesComponent, data: {title: 'Services'}},
  {path: 'contact', component: ContactComponent, data: {title: 'Contact'}},
  {path: 'orderpage', component: OrderpageComponent, data: {title: 'OrderPage'}, canActivate: [AuthGuard]},
  {path: 'orderdetails', component: OrderdetailsComponent, data: {title: 'OrderDetails'}, canActivate: [AuthGuard]},
